...
func (t *TUI) toolRenderDeps() toolview.RenderDeps {
	return toolview.RenderDeps{
		...
		Labels: toolview.RenderLabels{
			...
			ExecExited:           t.tr("tui.tool.exec.exited"),
			ExecStopped:          t.tr("tui.tool.exec.stopped"),
			ExecCleanup:          t.tr("tui.tool.exec.cleaned"),
			ExecJobID:            t.tr("tui.tool.exec.job_id"),
			ExecScope:            t.tr("tui.tool.exec.scope"),
			ExecRunCleanup:       t.tr("tui.tool.exec.run_cleanup"),
			ExecSessionCleanup:   t.tr("tui.tool.exec.session_cleanup"),
			ExecTimeout:          t.tr("tui.tool.exec.timeout"),
			ExecExitCode:         t.tr("tui.tool.exec.exit_code"),
			ExecCleanupStatus:    t.tr("tui.tool.exec.cleanup_status"),
		},
